...
determine the exact padding."
  :group 'my-doom-tomorrow-night-theme
  :type '(choice integer boolean))

(def-doom-theme my-doom-tomorrow-night
  "A theme based off of Chris Kempson's Tomorrow Dark."

  ;; name        gui       256       16
  ((bg         '("#0B0D0E" nil       nil          ))
   (bg-alt     '("#18191A" nil       nil          ))
   (base0      '("black"  "black"   "black"      ))
   (base1      '("#0E0E0E" "#1b1b1b"              ))
   (base2      '("#111112" "#1e1e1e"              ))
   (base3      '("#151616" "#292929" "brightblack"))
   (base4      '("#202121" "#3f3f3f" "brightblack"))
   (base5      '("#2F3030" "#525252" "brightblack"))
   (base6      '("#3C3E3E" "#6b6b6b" "brightblack"))
   (base7      '("#4D4E4D" "#979797" "brightblack"))
...
(provide 'my-doom-tomorrow-night-theme)
